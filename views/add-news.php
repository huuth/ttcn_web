...
<head>
    ...
    <title>PHÒNG TRỌ 69 | TRANG CHỦ</title>
    ...
    <!-- Bootstrap -->
    <link href="assets/css/bootstrapCopy.css" rel="stylesheet">
    <!-- slick slider -->
    ...
    <link type="text/css" rel="stylesheet" href="http://static.chotot.com.vn/css/17359-ai-form_general-html.css"/>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                <div class="aa-header-left">
                                    <div class="aa-telephone-no">
                                        <span class="fa fa-phone"></span> 1-900-6969-969
                                    </div>
        ...
        <nav class="navbar navbar-default main-navbar" role="navigation">
            <div class="container1">
                <div class="navbar-header">
                    ...
                    <!-- LOGO -->
                    <!-- Text based logo -->
                    <a class="navbar-brand aa-logo" href="index.html"> TRANG CHỦ <span>Property</span></a>
                    <!-- Image based logo -->
